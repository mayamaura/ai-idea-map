...
import { chatWithMap } from '../../services/claudeService'
...
export function AIChatPanel() {
  ...
  const handleSend = async (text?: string) => {
    ...
    try {
      ...
      addToast('AIチャットエラー: ' + (e instanceof Error ? e.message : '不明なエラー'), 'error')
    } finally {
      ...
      <div className="border-t border-gray-200 dark:border-gray-700 p-3">
        <div className="relative">
          ...
          <textarea
            ...
            placeholder={
              apiKey ? '@ノード名で参照、Enter で送信...' : '設定からAPIキーを設定してください'
            }
          ...
          <button
            ...
            disabled={!input.trim() || !apiKey || isChatLoading}
