          ...
          isSignedIn ? (
            <>
              <button
                ...
                className="flex items-center gap-1.5 px-2.5 py-1.5 text-xs text-gray-600 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors hidden sm:flex"
                title="マップ一覧"
              >
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1.5 text-xs text-gray-600 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50"
              title="Googleドライブに接続"
            >
              {isGoogleLoading ? (
