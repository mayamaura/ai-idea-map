  ...
  return (
    <div className="hidden sm:flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 z-10 flex-shrink-0">
      ...
      <button
        ...
        className="p-2 rounded-lg text-gray-500 dark:text-gray-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
      >
      ...
      <button
        onClick={undo}
        disabled={!canUndo}
        className="p-2 rounded-lg text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
        title="元に戻す (Ctrl+Z)"
      >
        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
      ...
      <div className="relative" ref={layoutMenuRef}>
        <button
          ...
          className="flex items-center gap-1.5 px-2.5 py-1.5 text-xs text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
          title="ノードを自動整列"
        >
        ...
        {showLayoutMenu && (
          <div className="absolute bottom-full mb-1 left-0 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg py-1 z-50 min-w-36 animate-context-menu">
            <button
      ...
      <div className="relative" ref={filterMenuRef}>
        <button
          ...
          className={`flex items-center gap-1.5 px-2.5 py-1.5 text-xs border rounded-lg transition-colors ${
            activeCategoryFilters.length > 0
              ? 'text-primary-600 dark:text-primary-400 border-primary-300 dark:border-primary-500 bg-primary-50 dark:bg-primary-900/30'
        ...
        {showFilterMenu && (
          <div className="absolute bottom-full mb-1 left-0 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg p-3 z-50 min-w-56 animate-context-menu">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs font-medium text-gray-600 dark:text-gray-400">カテゴリフィルター</span>
              {activeCategoryFilters.length > 0 && (
                <button
      ...
      <div className="relative flex" ref={presentMenuRef}>
        ...
        <button
          ...
          className={`flex items-center gap-1.5 px-2.5 py-1.5 text-xs border rounded-l-lg transition-colors border-r-0 ${
            presentationNodeIds.length > 0
              ? 'text-indigo-600 dark:text-indigo-400 border-indigo-300 dark:border-indigo-500 bg-indigo-50 dark:bg-indigo-900/30 hover:bg-indigo-100 dark:hover:bg-indigo-800/40'
        ...
        {showPresentMenu && (
          <div className="absolute bottom-full mb-1 right-0 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg py-1 z-50 min-w-52 animate-context-menu">
            <button
              onClick={() => {
                setShowPresentMenu(false)
                startPresentation()
              }}
              className="w-full flex items-center gap-2 px-3 py-2 text-xs text-gray-700 dark:text-gray-200 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 hover:text-indigo-700 dark:hover:text-indigo-300 transition-colors"
            >
      ...
      {/* ヘルプ: Ctrl+/ を知らないユーザーへの常時入口 */}
      <button
        onClick={() => setShortcutsModalOpen(true)}
        className="p-2 rounded-lg text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
        title="操作ガイド・ショートカット (Ctrl+/)"
      >
        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
