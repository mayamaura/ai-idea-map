      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md max-h-[80vh] flex flex-col">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-gray-700">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100">マップ一覧</h2>
          </div>
          <button
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          ...
          {error && (
            <div className="p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg text-sm text-red-600 dark:text-red-400 mb-3">
              {error}
            </div>
          )}
            ...
            <div className="space-y-2">
              {files.map((file) => (
                <button
                  ...
                  className="w-full flex items-center justify-between p-3 rounded-xl border border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-200 dark:hover:border-gray-500 transition-colors text-left"
                >
                  ...
                  <button
                    ...
                    className="p-1.5 text-gray-300 dark:text-gray-500 hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors flex-shrink-0 ml-2"
                    title="削除"
                  >
