import type { AISuggestion, Category, MapAnalysis, ConnectionSuggestion, ClusterSuggestion, GardenerSuggestion, ChatAction, ChatWithMapRequest, MapContext } from '../types'
